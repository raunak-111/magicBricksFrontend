...
const EditPropertyPage = () => {
  ...
  // Mock fetching property data
  useEffect(() => {
    // In a real app, we would fetch from API using the id
    setTimeout(() => {
      setFormData({
        title: "Luxury Apartment with Sea View",
        description: "This beautiful apartment offers panoramic sea views from its spacious balcony. Recently renovated with high-end finishes, it features an open-concept living area, modern kitchen with stainless steel appliances, and two well-appointed bedrooms.",
        type: "Apartment",
        status: "For Sale",
        price: "450000",
        area: "1200",
        ...
        images: [
          {
            preview: "https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=800&auto=format&fit=crop"
          },
          {
            preview: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&auto=format&fit=crop"
          },
          {
            preview: "https://images.unsplash.com/photo-1574739782594-db4ead022697?w=800&auto=format&fit=crop"
          }
        ]
      });
      setLoading(false);
